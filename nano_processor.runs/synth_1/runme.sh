...
HD_PWD='C:/dakshitha/nano_processor_project/nano_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PC_System.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PC_System.tcl
