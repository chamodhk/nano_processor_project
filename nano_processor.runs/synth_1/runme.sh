...
HD_PWD='C:/New folder/nano_processor_project/nano_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MUX_2_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MUX_2_4.tcl
