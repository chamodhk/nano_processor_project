...
HD_PWD='E:/nano_processor_project/nano_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder_2_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Decoder_2_4.tcl
